...
class GenerickeyController extends Controller
{
    private $module_title_singular = 'Generic Key';
    private $module_title_plural = 'Generic Keys';
    private $view_folder_name = 'generickeys';
    private $permission_initial = 'generic-keys';
    private $table_name = 'generic_keys';
    private $description_table_name = 'generic_keys_description';
    private $url_path = 'generickeys';
    ...
    public function get_data_ajax(Request $request){
        ...
        $query->join($this->description_table_name, $this->description_table_name.'.key_id', '=', $this->table_name.'.id');
    ...
    public function store(Request $request): RedirectResponse{
        ...
        $record = Generickey::create($input);
    ...
    public function update(Request $request, $id): RedirectResponse{
        ...
        foreach ($site_languages as $language) {
            ...
            $validate = DB::table($this->description_table_name)->where('key_id',$id)->where('language_id', $language->id)->first();
            if(empty($validate)){
                DB::table($this->description_table_name)->insert($description_data);
            }
            else{
