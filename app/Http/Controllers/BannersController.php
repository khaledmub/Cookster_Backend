...
{
    private $module_title_singular = 'Banner';
    private $module_title_plural = 'Banners';
    private $view_folder_name = 'banners';
    private $uploads_folder_name = 'banners';
    private $permission_initial = 'banners';
    private $table_name = 'banners';
    private $description_table_name = 'banners_description';
    private $url_path = 'banners';
    ...
    public function get_data_ajax(Request $request){
        ...
        $query->join($this->description_table_name, $this->description_table_name.'.banner_id', '=', $this->table_name.'.id');
    ...
    public function edit($id): View{
        $m_data = Banner::find($id);
        $m_data_descriptions = DB::table($this->description_table_name)->select()->where('banner_id',$id)->get()->keyBy('language_id');
        $data = array();
        $data['module_title_singular'] = $this->module_title_singular;
        $data['module_title_plural'] = $this->module_title_plural;
    ...
    public function update(Request $request, $id): RedirectResponse{
        ...
        foreach ($site_languages as $language) {
            ...
            $validate = DB::table($this->description_table_name)->where('banner_id',$id)->where('language_id', $language->id)->first();
            if(empty($validate)){
                DB::table($this->description_table_name)->insert($description_data);
            }
            else{
    ...
    public function destroy($id): RedirectResponse
    {
        ...
        DB::table($this->description_table_name)->where('banner_id',$id)->delete();
