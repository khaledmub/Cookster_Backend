...
{
    private $module_title_singular = 'Screen';
    private $module_title_plural = 'Screens';
    private $view_folder_name = 'screens';
    private $uploads_folder_name = 'screens';
    private $permission_initial = 'screens';
    private $table_name = 'screens';
    private $description_table_name = 'screens_description';
    private $url_path = 'screens';
    ...
    public function get_data_ajax(Request $request){
        ...
        $query->join($this->description_table_name, $this->description_table_name.'.screen_id', '=', $this->table_name.'.id');
        ...
        $data = $query2->select([$this->table_name.'.*', $this->description_table_name.'.title', $this->description_table_name.'.sub_title', $this->description_table_name.'.short_description'])->get();
        $dataToPass=array();
    ...
    public function edit($id): View{
        $m_data = Screen::find($id);
        $m_data_descriptions = DB::table($this->description_table_name)->select()->where('screen_id',$id)->get()->keyBy('language_id');
        $data = array();
        $data['module_title_singular'] = $this->module_title_singular;
        $data['module_title_plural'] = $this->module_title_plural;
    ...
    public function update(Request $request, $id): RedirectResponse{
        ...
        foreach ($site_languages as $language) {
            ...
            $validate = DB::table($this->description_table_name)->where('screen_id',$id)->where('language_id', $language->id)->first();
            if(empty($validate)){
                DB::table($this->description_table_name)->insert($description_data);
            }
            else{
    ...
    public function destroy($id): RedirectResponse
    {
        ...
        DB::table($this->description_table_name)->where('screen_id',$id)->delete();
