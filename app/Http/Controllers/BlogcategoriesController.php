...
{
    private $module_title_singular = 'Blog Category';
    private $module_title_plural = 'Blog Categories';
    private $view_folder_name = 'blogcategories';
    private $uploads_folder_name = 'blogcategories';
    private $permission_initial = 'blogcategories';
    private $table_name = 'blogcategories';
    private $description_table_name = 'blogcategories_description';
    private $url_path = 'blogcategories';
    ...
    public function get_data_ajax(Request $request){
        ...
        $query->join($this->description_table_name, $this->description_table_name.'.blogcategory_id', '=', $this->table_name.'.id');
        ...
        $data = $query2->select([$this->table_name.'.*', $this->description_table_name.'.title'])->get();
        $dataToPass=array();
    ...
    public function store(Request $request): RedirectResponse{
        ...
        $record = Blogcategory::create($input);
    ...
    public function edit($id): View{
        $m_data = Blogcategory::find($id);
        $m_data_descriptions = DB::table($this->description_table_name)->select()->where('blogcategory_id',$id)->get()->keyBy('language_id');
        $data = array();
        $data['module_title_singular'] = $this->module_title_singular;
        $data['module_title_plural'] = $this->module_title_plural;
    ...
    public function destroy($id): RedirectResponse
    {
        ...
        DB::table($this->description_table_name)->where('blogcategory_id',$id)->delete();
