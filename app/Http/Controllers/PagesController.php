...
{
    private $module_title_singular = 'Page';
    private $module_title_plural = 'Pages';
    private $view_folder_name = 'pages';
    private $uploads_folder_name = 'pages';
    private $permission_initial = 'pages';
    private $table_name = 'pages';
    private $description_table_name = 'pages_description';
    private $url_path = 'pages';
    ...
    public function get_data_ajax(Request $request){
        ...
        $query->join($this->description_table_name, $this->description_table_name.'.page_id', '=', $this->table_name.'.id');
        ...
        $data = $query2->select([$this->table_name.'.*', $this->description_table_name.'.title', $this->description_table_name.'.sub_title', $this->description_table_name.'.short_description', $this->description_table_name.'.description'])->get();
        $dataToPass=array();
    ...
    public function edit($id): View{
        $m_data = Page::find($id);
        $m_data_descriptions = DB::table($this->description_table_name)->select()->where('page_id',$id)->get()->keyBy('language_id');
        $data = array();
        $data['module_title_singular'] = $this->module_title_singular;
        $data['module_title_plural'] = $this->module_title_plural;
    ...
    public function destroy($id): RedirectResponse
    {
        ...
        DB::table($this->description_table_name)->where('page_id',$id)->delete();
