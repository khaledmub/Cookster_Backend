    ...
    <div class="container-fluid">
        ...
        <div class="profile-foreground position-relative mx-n4 mt-n4">
            <div class="profile-wid-bg">
                <img src="{{ asset('assets/admin/images/c-bg.jpg') }}" alt="" class="profile-wid-img" />
            </div>
        </div>
                ...
                <div class="col-auto">
                    <div class="avatar-lg">
                        ...
                        if($data['general_data']->image!=''){
                            ...
                            $image = asset('assets/admin/images/users/c-dummy.png');
                        }
                        @endphp
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered mb-0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <th class="" scope="row">State</th>
                                                            <td class="text-muted">{{$data['additional_data']->state_name}}</td>
