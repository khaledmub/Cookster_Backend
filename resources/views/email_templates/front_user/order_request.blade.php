                ...
                <td class="specbundle3">
                  <div class="contentEditableContainer contentTextEditable">
                    <div class="contentEditable">
                      <p style="color:#028B8B;text-align:left;font-weight:bold;">Dear {{$video_details->user_name}}</p>
                      <p style="color:#666666;text-align:left;">New order request from the customer.</p>
