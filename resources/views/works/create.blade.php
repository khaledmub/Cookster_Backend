                                    ...
                                    <div class="row mt-4">
                                        <div class="col-xs-3 col-sm-3 col-md-3 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="number[{{$s_language->id}}]" placeholder="" class="form-control" value="{{ old('number.'.$s_language->id) }}">
                                            </div>
                                        </div>
                                        <div class="col-xs-3 col-sm-3 col-md-3 mb-3">
                                            <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="sort_order" placeholder="" class="form-control" value="{{ old('sort_order') }}">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                    <div class="form-group">
