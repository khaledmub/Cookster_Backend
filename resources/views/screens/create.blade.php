                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-xs-3 col-sm-3 col-md-3 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="sub_title[{{$s_language->id}}]" placeholder="" class="form-control" value="{{ old('sub_title.'.$s_language->id) }}">
                                            </div>
                                        </div>
                                        <div class="col-12 mb-3">
                                            <div class="form-group">
                                                <label class="form-label">Short Description</label>
                                                <textarea rows="5" class="form-control" name="short_description[{{$s_language->id}}]">{{ old('short_description.'.$s_language->id) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
