                            ...
                            <div class="card mt-4">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="text-center mt-2">
                                        <h5 class="text-primary text-theme">Welcome Back !</h5>
                                        ...
                                        <form method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="position-relative auth-pass-inputgroup mb-3">
                                                    <input type="password" class="form-control pe-5 @error('password') is-invalid @enderror" name="password" id="password-input">
