...
<div class="page-content">
    <div class="container-fluid">
        ...
        <form method="POST" action="{{ route($data['url_path'].'.update', $m_data->id) }}">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-9">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-xs-3 col-sm-3 col-md-3 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name[{{$s_language->id}}]" placeholder="" class="form-control" value="{{ $m_data_descriptions[$s_language->id]->name }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select name="key_id" class="form-select select2">
                                            ...
                                            <option {{ $m_data->key_id && $m_data->key_id==$gkey->id ? 'selected' : '' }} value="{{ $gkey->id }}">{{ $gkey->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
