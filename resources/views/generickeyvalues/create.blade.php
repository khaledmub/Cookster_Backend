                                    ...
                                    <div class="row mt-4">
                                        <div class="col-xs-3 col-sm-3 col-md-3 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name[{{$s_language->id}}]" placeholder="" class="form-control" value="{{ old('name.'.$s_language->id) }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select name="key_id" class="form-select select2">
                                            ...
                                            <option {{ (old('key_id') && old('key_id')==$gkey->id || request()->key_id && request()->key_id==$gkey->id) ? 'selected' : '' }} value="{{ $gkey->id }}">{{ $gkey->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
