                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="amount" placeholder="" class="form-control" value="{{ $m_data->amount }}">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                    <div class="form-group">
                                        <label class="form-label">Duration (Months) <span class="text-danger">*</span></label>
                                        <input type="number" name="duration" placeholder="" class="form-control" value="{{ $m_data->duration }}">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                    <div class="form-group">
