...
return [
    ...
    'forgot_code_email_failed' => "تعذر إرسال بريد التحقق الآن. يرجى المحاولة مرة أخرى بعد قليل.",
    ...
    'username_format' => 'اسم المستخدم يجب أن يحتوي على أحرف إنجليزية صغيرة وأرقام وشرطة سفلية فقط.',
    'username_min' => 'اسم المستخدم يجب أن يكون 3 أحرف على الأقل.',
    'username_max' => 'اسم المستخدم يجب ألا يتجاوز 30 حرفًا.',
    'username_taken' => 'اسم المستخدم هذا مستخدم بالفعل.',
    'email_already_registered' => 'هذا البريد الإلكتروني مسجل بالفعل.',
    'registration_otp_sent' => 'تم إرسال رمز التحقق. يرجى التحقق من بريدك الإلكتروني.',
    'registration_otp_resent' => 'تم إعادة إرسال رمز التحقق. يرجى التحقق من بريدك الإلكتروني.',
    'registration_otp_required' => 'يجب التحقق من البريد الإلكتروني قبل تسجيل الدخول.',
    'otp_send_failed' => 'تعذر إرسال بريد التحقق الآن. يرجى المحاولة مرة أخرى.',
    'otp_invalid' => 'رمز التحقق غير صالح.',
    'otp_expired' => 'انتهت صلاحية رمز التحقق. يرجى طلب رمز جديد.',
    'otp_resend_rate_limited' => 'يرجى الانتظار قبل طلب رمز تحقق آخر.',
];
